...
""""""
[한솔테크닉스 HEVH] Shipment Cut-off 알람 v30.2
- 작성자 기준 (현재재고 = 첫 Plan 일자 전날 시점)
- Cutoff시점재고: 6/13부터 cutoff까지 누적 (과거=실적, 미래=계획)
- 정렬: components.html
"""
...
def analyze(ship_db, prod_db, plan_date_cols, note_dict):
    ...
    # ⭐ Cutoff시점재고: 현재재고 + 첫 Plan일자부터 cutoff까지 누적 (과거=실적, 미래=계획)
